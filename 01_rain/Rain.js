/**
 * Define a new class of the Rain.js.
 * @param canvasId is the DOM id of the canvas used for rendering
 * @param imageId is the DOM id of the image element used as background image
 * @param width is the window width of the rendering
 * @param height is the window height of the rendering
 * @param opacity opacity attribute value of the glass canvas (default: 1)
 * @param blur radius (default: 20)
 */
class Rain{
    constructor(canvasId,imageId,width,height,opacity,blur){
        //canvas Dom
    ...
    prepareReflections(){
        ...
        ctx.drawImage(this.image, -this.reflected.width / 2, -this.reflected.height / 2, this.reflected.width, this.reflected.height);
    }
 ...
 */
Rain.prototype.TRAIL_NONE = function(drop) {
 ...
 * @param drop raindrop object
 */
Rain.prototype.TRAIL_DROPS = function(drop) {
 ...
 * @returns true if the animation is stopped
 */
Rain.prototype.GRAVITY_NONE = function(drop) {
    return true;
};
 ...
 * @returns true if the animation is stopped
 */
Rain.prototype.GRAVITY_LINEAR = function(drop) {
    if (drop.clear()) {
        return true;
    }
 ...
 * @returns true if the animation is stopped
 */
Rain.prototype.GRAVITY_NON_LINEAR = function(drop) {
    if (drop.clear()) {
        return true;
    }
 ...
 * @param drop raindrop object
 */
Rain.prototype.REFLECTION_NONE = function(drop) {
 ...
 * @param drop raindrop object
 */
Rain.prototype.REFLECTION_MINIATURE = function(drop) {
 ...
 */
Rain.prototype.COLLISION_SIMPLE = function(drop1, drop2) {
    drop1.clear();
 ...
 */
Rain.prototype.prepareBackground = function(radius, width, height) {
    if (width && height) {
 ...
 */
Rain.prototype.stackBlurCanvasRGB = function(top_x, top_y, width, height, radius) {
    radius |= 0;
